...
AppModule = __decorate([
    Object(__WEBPACK_IMPORTED_MODULE_2__angular_core__["M" /* NgModule */])({
        ...
        providers: [__WEBPACK_IMPORTED_MODULE_8__services_unicorn_service__["a" /* UnicornService */], __WEBPACK_IMPORTED_MODULE_12__services_notification_service__["a" /* NotificationService */]],
...
var NewUnicornComponent = (function () {
    ...
    NewUnicornComponent.prototype.createUnicorn = function () {
        ...
        if (this.unicornService.isUniqueName(this.unicorn.name)) {
            ...
            setTimeout(function () {
                _this.router.navigate(["/unicorn", _this.unicorn.name]);
...
module.exports = "<div *ngIf=\"unicorn.age >=5\">\n\n    <h2>Select Mate</h2>\n    <form #mateForm='ngForm'>\n        <md-select placeholder=\"Mate\" name=\"mate\" [(ngModel)]=\"mateName\" required>\n            <md-option *ngFor=\"let unicorn of matingUnicorns\" [value]=\"unicorn.name\">\n                {{unicorn.name}}\n                <span><b>Gender: </b>{{unicorn.gender}} </span>\n            </md-option>\n        </md-select>\n        <button md-button md-raised-button color=\"primary\" [disabled]=\"!mateForm.valid || isSubmited\" (click)=\"mateUnicorns()\">Mate</button>\n    </form>\n</div>\n<md-spinner *ngIf=\"isSubmited\"></md-spinner>\n<div>\n    <img src=\"{{unicorn.picture}}\" />\n    <div>\n        <h2>Personal Info </h2>\n        <div>\n            <b>Name:</b> {{unicorn.name}}\n        </div>\n        <div>\n            <div>\n                <b>Color:</b> {{unicorn.color}}\n            </div>\n            <div class=\"displayColor\" [ngStyle]=\"{'background-color':'#'+color}\"> </div>\n        </div>\n        <div>\n            <b>Gender:</b> {{unicorn.gender}}\n        </div>\n        <div>\n            <b>Age:</b> {{unicorn.age}}\n        </div>\n    </div>\n</div>"
...
var UnicornsComponent = (function () {
    ...
    UnicornsComponent.prototype.getCols = function () {
